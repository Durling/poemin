...
function showWxOptionListMore(_guid)
{
	...
	$("#loadmorebtn").hide();
	$.post(serverroot+"op.php", {action:"loadvoteoptionbypage",guid:_guid,page:wxpage,tpldiyfile:tpldiyfile},function(json){
...
function initWxVoteBtnClk()
{
	...
	{
		$("#geetestdiv").html("<script type='text/javascript' src='http://api.geetest.com/get.php?gt=b6f922650c871f9640ac7e2bd4afeea7&product=embed'></script>");
	}
